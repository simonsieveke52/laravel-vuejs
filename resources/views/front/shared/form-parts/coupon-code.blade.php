<label for="coupon_code" class="d-flex flex-wrap justify-content-between mb-0">
    ...
    <div class="col-5 pr-0">
        <button type="button" class="btn-highlight btn link link--hover__bg-brand-secondary col-12 py-2 fw-700 uppercase coupon-code-button" type="secondary">Apply</button>
    </div>
</label>